...
public class A_Drivers {
    ...
    public void chromeDriverUsingSystemProperty() {
        ...
        System.setProperty("webdriver.chrome.driver", "D:/Mateusz/Documents/chromedriver.exe");
        WebDriver driver = new ChromeDriver();
        driver.quit();
    }
    ...
    public void firefoxGeckoDriverUsingSystemProperty() {
        System.setProperty("webdriver.gecko.driver", "D:/Mateusz/Documents/geckodriver.exe");
        WebDriver driver = new FirefoxDriver();
        driver.quit();
    }
    ...
    public void edgeMsedgeDriverUsingSystemProperty() {
        System.setProperty("webdriver.edge.driver", "D:/Mateusz/Documents/msedgedriver.exe");
        WebDriver driver = new EdgeDriver();
        driver.quit();
    }
